...
app.get('/manager_orders', function (req, res) {
    handleDisconnect()
    console.log('getting orders')
    connection.query('SELECT * FROM manager_orders', function (error, results, fields) {
        if (error) {
            throw error
            handleDisconnect()
        }
...
app.get('/managerlogin', function (req, res) {
    handleDisconnect()
    console.log('getting all completed staff orders')
...
app.post('/waiter_alerts', function (req, res) {
    ...
    connection.query('INSERT INTO waiter_alerts SET customerSessionID=?', req.body.customerSessionID, function (error, results, fields) {
        if (error) {
            throw error
            handleDisconnect()
        }
